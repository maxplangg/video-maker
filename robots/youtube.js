...
async function robot() {
    ...
    async function authenticateWithOAuth() {
        ...
        await requetGoogleForAccessTokens(OAuthClient, authorizationToken)
    ...
    function requestUserConsent(OAuthClient) {
        ...
        console.log(`> [youtube-robot] Please give you consent: ${consentUrl}`)
    }

    function waitForGoogleCallback(webServer) {
        return new Promise((resolve, reject) => {
    ...
    async function requetGoogleForAccessTokens(OAuthClient, authorizationToken) {
        return new Promise((resolve, reject) => {
    ...
    function stopWebServer(webServer) {
        return new Promise((resolve, reject) => {
